                    ...
                    <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            ...
                            <div class="dropdown-user-details">
                                <div class="dropdown-user-details-name">Mamad Ahmad</div>
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    ...
                    <div class="sidenav-footer">
                        <div class="sidenav-footer-content">
                            ...
                            <div class="sidenav-footer-title">Mamad Ahmad</div>
                        </div>
                    </div>
                </nav>
            </div>
                    ...
                    <div class="container-xl px-4 mt-n10">
                        <div class="row">
                            <div class="col-xxl-4 col-xl-12 mb-4">
                                <div class="card h-70">
                                    <div class="card-body h-70 p-5">
                                        <div class="row align-items-center">
                                            <div class="col-xl-8 col-xxl-12">
                                                <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                                    <h1 class="text-primary">Welcome, Mamad Ahmad!</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header text-dark">Pembayaran Terakhir</div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Registrasi</td>
                                            <td>3.500.000</td>
                                            <td><div class="badge bg-success text-white rounded-pill">settlement</div></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
